...
(function($){
	...
	var PageSwitch = (function(){
		...
		PageSwitch.prototype = {
			...
			init : function(){
				...
				me.canscroll = true;//动画上锁

				if(!me.direction || me.index){//如果是横屏
					me._initLayout();
				}
			...
			/*说明：主要针对横屏情况进行页面布局，实现分页的dom结构及css样式*/
	...
	$.fn.PageSwitch = function(options){
		return this.each(function(){
			var me = $(this),
				instance = me.data("PageSwitch");// instance存放插件实例

			if(!instance){// 如果实例为空则new一个对象
